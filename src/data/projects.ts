...
import guidely from "../assets/screenshots/guidely.png";
...
export const projects: ProjectDetail[] = [
  
  {
    title: "Guidely",
    description:
      "An AI-powered customer service agent we vibe-coded at a hackathon. It uses a RAG pipeline to deliver accurate, context-aware answers, and—unlike a typical chatbot—it can perform real actions through tool-calling, allowing it to execute tasks, trigger workflows, and interact with external systems.",
    technologies: ["NextJS", "MongoDB", "Vercel", "OpenAI", "Copilot"],
    url: "https://github.com/usharabkhan/guidely",
    demoUrl: "",
    bullets: [
      "",
      "",
  ...
  },
  {
    ...
    description:
      "Full-stack membership & events management for the Muslim Students' Association with role-based access and analytics dashboard.",
    technologies: ["NextJS", "MongoDB", "Tailwind CSS", "TypeScript", "Azure", "Vercel"],
  ...
  },
  {
    ...
    description:
      "A Tableau dashboard visualizing traffic incident data from Calgary, showcasing trends and patterns in incidents over time.",
  ...
  },
  {
    ...
    description:
      "Collaborated on a full-stack hiking social network web app featuring user authentication, hike tracking, and social functionality, using Docker containerization to streamline development and deployment.",
  ...
  },
  {
    ...
    description:
      "Social platform for university students. Employed Task Centered System Design process to iteratively create an elegant UI/UX. (Course Project)",
  ...
  },
  {
    ...
    description:
      "Application to track school visits, emails, and recruitment progress, providing insights on students and schools reached. Integrated MySQL for backend data management.",
  ...
  },
  {
    ...
    description:
      "A JavaFX desktop application for the Pakistani Students' Society to manage memberships and event registrations, featuring a dashboard and member status cross-checking with SQLite integration.",
